...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-slate-100 via-white to-slate-50 text-gray-900 font-sans flex overflow-hidden">
      ...
      {/* SIDEBAR */}
      <aside className="w-72 bg-white border-r border-slate-200 flex flex-col shrink-0 z-20 shadow-xl relative text-slate-800">
        <div className="h-24 flex items-center gap-4 px-8 border-b border-slate-200 bg-white">
        ...
        <nav className="flex-1 py-8 flex flex-col gap-2 px-4 relative z-10 bg-white">
          <button 
            onClick={() => setActiveTab('command_center')}
            className={`flex items-center gap-4 px-6 py-4 rounded-lg text-xs font-bold uppercase tracking-widest transition-all duration-300 ${activeTab === 'command_center' ? 'bg-gradient-to-r from-gov-blue to-[#1a365d] text-white shadow-md border border-[#1a365d]' : 'text-slate-600 hover:text-gov-blue hover:bg-slate-50 border border-transparent'}`}
          >
          ...
          <button 
            ...
            className={`flex items-center gap-4 px-6 py-4 rounded-lg text-xs font-bold uppercase tracking-widest transition-all duration-300 ${activeTab === 'radar' ? 'bg-gradient-to-r from-gov-blue to-[#1a365d] text-white shadow-md border border-[#1a365d]' : 'text-slate-600 hover:text-gov-blue hover:bg-slate-50 border border-transparent'}`}
          >
        ...
        <div className="p-6 border-t border-slate-200 bg-slate-50 relative z-10">
          <div className="flex items-center gap-3 mb-6 bg-white p-3 rounded shadow-sm border border-slate-100">
